...
export function LandingFeatures() {
  return (
    <div className="border-t border-stone-300/50 bg-stone-100">
      <div className="max-w-6xl mx-auto px-6 py-32 w-full flex flex-col">
        ...
        <div className="flex flex-col md:flex-row gap-16 mb-32 mt-12">
          <div className="flex-1 space-y-4">
            <div className="text-accent font-bold tracking-widest text-sm uppercase">01 / Speed</div>
          ...
          <div className="flex-1 space-y-4">
            <div className="text-accent font-bold tracking-widest text-sm uppercase">02 / Privacy</div>
        ...
        <div className="bg-stone-900 rounded-4xl p-12 md:p-16 flex flex-col md:flex-row items-center justify-between text-white shadow-xl">
